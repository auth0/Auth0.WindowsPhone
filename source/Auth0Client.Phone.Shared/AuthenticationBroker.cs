...
namespace Auth0.SDK
{
    ...
    {
        private static char[] AmpersandChars = new char[] { '&' };
        private static char[] EqualsChars = new char[] { '=' };
        ...
        /// Thrown if Root Frame of the application equals <c>null</c>.
        /// </exception>
        /// <exception cref="AuthenticationCancelException">
        /// Thrown if the user cancels the authentication flow.
        /// </exception>
        /// <exception cref="AuthenticationErrorException">
        /// Thrown if an error occurs during the authentication flow.
        /// </exception>
...
#endif
            Task<Auth0User> task = Task<Auth0User>.Run(() =>
            {
